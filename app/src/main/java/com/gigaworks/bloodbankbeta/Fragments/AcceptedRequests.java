...
import com.gigaworks.bloodbankbeta.AcceptedAdaptor;
...
public class AcceptedRequests extends Fragment {
    ...
    private AcceptedAdaptor mAcceptedAdaptor;
    private LinearLayoutManager mLayoutManager;
    private static final String RESPONSE_URL="https://gigaworks.000webhostapp.com/accepted_requests.php";
    private Context ctx;
    ...
    public static AcceptedRequests newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView=(RecyclerView)view.findViewById(R.id.rv_accepted_requests);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAcceptedAdaptor=new AcceptedAdaptor(list);
        mRecyclerView.setAdapter(mAcceptedAdaptor);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response!=null){
                            ...
                            pd.dismiss();
                            mAcceptedAdaptor.notifyDataSetChanged();
                        }
                        else {
                            pd.dismiss();
                        }
